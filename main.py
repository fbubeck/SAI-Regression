...
def main():
    ...
    ax1.set_ylabel('Model-Performance (Accuracy)', fontsize=11)
    ax2.set_xlabel('Duration [in seconds]', fontsize=11)
    ax2.set_ylabel('Model-Performance (Accuracy)', fontsize=11)
    ...
    plt.legend(["TensorFlow CNN ", "TensorFlow ANN", "Logistic Regression", "Random Forest"], fontsize=11, loc='lower center',
